...
$sql="insert into customer (customer_id,first_name,last_name,branch_id,dob,age,street,city,state,pincode,address) values($cust_id,
'$first_name','$last_name',$bran_id,'$dob',$age,'$street','$city','$state',$pincode,'$address');";
...
<div class="container">
<form action="newCustomer_admin.php"  method="post">
   <div class="row">
    <div class="col-25">
